...
if __name__ == "__main__":
    ...
    print(f"Electric car {electric_car.reg_number} travelled {electric_car.travelled_distance} km.")
    print(f"Gasoline car {gasoline_car.reg_number} travelled {gasoline_car.travelled_distance} km.")
